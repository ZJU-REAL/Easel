      ...
      <div className="drawer" onClick={(e) => e.stopPropagation()}>
        <div className="drawer-header">
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12 }}>
            <div>
              <div className="skill-detail-title">{detail?.displayName || skillName}</div>
              <div className="skill-card-slug">{skillName}</div>
              <p className="page-subtitle">{detail?.displayDescription}</p>
