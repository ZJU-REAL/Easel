    ...
    <div className="sidebar">
      <div className="sidebar-header">
        <div className="sidebar-logo">
          <SealLogo className="seal-logo-mark" size={42} />
          <div className="sidebar-brand-copy"><h1>Seal</h1><small>您的私人运营顾问</small></div>
        </div>
        <select
      ...
      <div className="sidebar-status">
        <span className={`status-dot ${runtimeStatus === 'connected' ? '' : 'offline'}`} />
      ...
      <a className="source-badge" href="https://github.com/ZJU-REAL/Easel" target="_blank" rel="noreferrer">源自开源项目Easel ↗</a>
    </div>
  );
}
