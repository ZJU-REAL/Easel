...
未指定模式时默认执行 A + B + C。模式 D 前先运行 `python ../bundled-skills/skill-data-tracker/scripts/track.py export-followers`。
...
```bash
python ../bundled-skills/skill-publish-analytics/scripts/analyze.py all
python ../bundled-skills/skill-publish-analytics/scripts/analyze.py --profile 画像名 time
python ../bundled-skills/skill-publish-analytics/scripts/analyze.py --profile 画像名 tags
python ../bundled-skills/skill-publish-analytics/scripts/analyze.py --profile 画像名 types
python ../bundled-skills/skill-publish-analytics/scripts/analyze.py --profile 画像名 growth
```
