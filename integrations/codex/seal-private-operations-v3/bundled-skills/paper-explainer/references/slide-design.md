...
```bash
python ../bundled-skills/paper-explainer/scripts/render_slides.py validate \
  --plan outputs/<项目>/assets/slide-plan.json

python ../bundled-skills/paper-explainer/scripts/render_slides.py render \
  --plan outputs/<项目>/assets/slide-plan.json \
  --out-dir outputs/<项目>/assets/slides

python ../bundled-skills/paper-explainer/scripts/render_slides.py audit \
  --plan outputs/<项目>/assets/slide-plan.json \
