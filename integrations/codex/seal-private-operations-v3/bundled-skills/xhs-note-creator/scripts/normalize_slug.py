...
Usage:
    python normalize_slug.py "GPT-5.4深夜炸场：OpenAI 大一统模型来了" [--max 15]
    python normalize_slug.py --timestamp   # just print YYYYMMDDHHmm in Asia/Shanghai
    python normalize_slug.py "..." --with-ts   # "<slug>_YYYYMMDDHHmm"
"""
