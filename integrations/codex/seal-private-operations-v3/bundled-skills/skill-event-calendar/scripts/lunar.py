...
用法：
    ...
    python lunar.py l2s 2025 1 1
    python lunar.py l2s 2023 2 1 --leap        # 闰二月初一
    # 公历 → 农历
    python lunar.py s2l 2025-10-06
    # 某农历节日在指定公历年的日期
    python lunar.py festival 中秋 2025
    python lunar.py festival --list            # 列出支持的节日
    # 自测锚点
    python lunar.py selftest
