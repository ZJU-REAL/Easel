...
```bash
python ../bundled-skills/skill-wechat-publisher/scripts/newspic_build.py brief.md
...
python ../bundled-skills/skill-wechat-publisher/scripts/ai_score.py brief.md --mode newspic --threshold 45
```
...
```bash
python ../bundled-skills/skill-wechat-publisher/scripts/publish.py --account main --type newspic --brief brief.md --exec
# 或显式覆盖风格
python ../bundled-skills/skill-wechat-publisher/scripts/publish.py --account main --type newspic --brief brief.md --image-style knowledge-card --exec
```
