...
> 对着一个**具体账号**做归因式体检并开处方。读 [profile-builder](../skill-profile-builder/CAPABILITY.md) 生成的画像 + 用户近期内容/数据 → 诊断账号健康 → 给分阶段起号意见与发布建议。**与画像强相关**：没有完善的 Profile 就先去跑 profile-builder。
