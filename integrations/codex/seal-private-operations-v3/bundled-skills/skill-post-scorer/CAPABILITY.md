...
```bash
python ../bundled-skills/skill-post-scorer/scripts/score.py top --input history.json
python ../bundled-skills/skill-post-scorer/scripts/score.py top --input history.json --top-pct 5
```
